...
class Config {
    ...
    // Docker config
    fun getDockerMaxConnections(): Int =
        getConfig("DOCKER_MAX_CONNECTIONS", "100").toInt()

    fun getDockerConnectionTimeout(): Long =
        getConfig("DOCKER_CONNECTION_TIMEOUT", "30").toLong()

    fun getDockerResponseTimeout(): Long =
        getConfig("DOCKER_RESPONSE_TIMEOUT", "45").toLong()
}